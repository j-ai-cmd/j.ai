/* Bencho — Slide to confirm. MIT © 2026 Lorenzo Cabra — bencho.dev/licence
   Source copied from the block's Code pane; j.ai edits are marked. */
...
export function SlideConfirm({
  ...
  width = SPAN,
  /* j.ai: wiring only — the resting label and a callback on commit */
