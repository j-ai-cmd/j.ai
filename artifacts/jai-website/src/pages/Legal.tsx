    ...
    <div className="legal-root">
      ...
      <section className="l-run">
        <div className="wrap">
          <Reveal className="sec-head">
            ...
            <div className="note">Agents do the work. You keep the judgement. Run, review, approve or skip.</div>
          </Reveal>
      ...
      <section className="l-book" id="book">
        <div className="wrap">
          <Reveal className="sec-head">
            <h2>Book a call.</h2>
            <div className="note">Pick a time. We map out what is worth automating in your firm.</div>
          </Reveal>
          <Reveal>
