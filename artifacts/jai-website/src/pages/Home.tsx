  ...
  return (
    <div>
      ...
      <section className="h-hero">
        <div className="wrap">
          <RevealHeading as="h1" text="New AI tools land every week. You don’t have time to work out which ones matter." />
      ...
      <section className="h-gap">
        <div className="wrap">
          <div className="grid">
            <RevealHeading text="The gap is quiet, and it widens." />
            <Reveal>
      ...
      <section className="h-offer">
        <div className="wrap">
          <RevealHeading text="Two ways to work with j.ai." />
          <Spotlight className="amc-spot" glowColor="rgba(122,46,59,0.08)" glowSize={320}>
          <div className="row">
      ...
      <section className="h-how">
        <div className="wrap">
          <RevealHeading text="We strongly believe AI is here to do the work you don’t want, so you can do the work you were meant for." />
      ...
      <section className="h-why">
        <div className="wrap">
          <div className="grid">
            <RevealHeading text="You started your business to do the work you’re good at." />
            <Reveal>
